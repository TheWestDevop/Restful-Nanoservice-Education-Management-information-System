...
<head>
  ...
  <title>EDUCATION | ADMIN PORTAL </title>
...
<script src="js/canvasjs-2.0.1/canvasjs.min.js" type="text/javascript"></script> 
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <li class="user-header" >
                ...
                <br><b style="color: white;" ><%=request.getAttribute("username")%>  ADMINISTRATOR</b>
              </li>
...
<script src="js/canvasjs-2.0.1/canvasjs.min.js" type="text/javascript"></script>
<script src="js/canvasjs-2.0.1/jquery.canvasjs.min.js" type="text/javascript"></script>
